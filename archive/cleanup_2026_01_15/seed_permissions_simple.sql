...
-- Simplified version - Just inserts permissions
-- ============================================

DO $$
DECLARE
    current_tenant UUID;
    device_perm_ids UUID[];
    session_perm_ids UUID[];
BEGIN
    ...
    ON CONFLICT DO NOTHING RETURNING id INTO device_perm_ids[1];
    ...
    RAISE NOTICE '============================================';
    RAISE NOTICE '';
    RAISE NOTICE 'Verify by running:';
    RAISE NOTICE '  SELECT "Code", "Name" FROM permissions WHERE "Module" IN (''device_management'', ''session_management'');';
    RAISE NOTICE '';
END $$;
