-- Fix mappings with ACTUAL permission codes

-- 1. Front Desk Officer (6 permissions: patient registration + appointments)
...
-- 2. Medical Records Officer (8 permissions: patient records + document management)
INSERT INTO role_permissions (id, "RoleId", "PermissionId", "CreatedAt", status)
SELECT 
    gen_random_uuid(),
    r.id,
...
-- Final verification - ALL 20 roles
SELECT 
    r.name,
