      ...
      <div className="bg-gray-50 rounded-xl border p-4 text-xs text-gray-500 space-y-1">
        ...
        <div className="flex flex-wrap gap-4">
          <span className="inline-flex items-center gap-1.5">
            <span className="w-3 h-3 rounded-full bg-green-400 inline-block" /> ≥ 85 — Excellent
          </span>
          <span className="inline-flex items-center gap-1.5">
            <span className="w-3 h-3 rounded-full bg-yellow-400 inline-block" /> 65–84 — Good
          </span>
          <span className="inline-flex items-center gap-1.5">
            <span className="w-3 h-3 rounded-full bg-red-400 inline-block" /> &lt; 65 — Needs Improvement
          </span>
        </div>
